-- CKA BuildStruct — secure public project submission with optional private file
...
create policy "staff manage project-uploads"
...
begin
  ...
  v_kind := case
    ...
    when p_file_name ~* '\.(xls|xlsx)$' then 'boq'::public.file_kind
